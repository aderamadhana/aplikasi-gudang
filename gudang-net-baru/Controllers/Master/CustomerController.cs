...
namespace gudang_net_baru.Controllers.Master
{
    public class CustomerController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Edit(string id, CustomerDto customerDto)
        {
            var cek = context.MasterCustomer.Find(id);
            if (cek == null)
            {
                return RedirectToAction("Index");
            }
            ...
            cek.NamaCustomer = customerDto.NamaCustomer;
            cek.Alamat = customerDto.Alamat;
            cek.JenisCustomer = customerDto.JenisCustomer;
            cek.Status = true;
